...
# --- Changelog ---
# Version 0.09:
#   - Fixed bug where host file was not updated after key installation.
#   - Rewrote update_timestamp() and update_key_status() to use a robust
#     awk-based field lookup instead of a brittle line replacement.
#
# Version 0.08:
